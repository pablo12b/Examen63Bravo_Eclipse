...
a persistence unit "Examen63BravoPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "Examen63Bravo/pom.xml":
...
artifact ("Examen63Bravo.war") is already built. You can build
